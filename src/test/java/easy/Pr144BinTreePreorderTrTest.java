...
public class Pr144BinTreePreorderTrTest {
  ...
  private static Stream<Arguments> provideData() {
    ...
    List<Integer> preOrderValues = Arrays.asList(5, 4, 11, 7, 2, 8, 13, 4, 1);
    ...
    return Stream.of(
      Arguments.of(n5, preOrderValues)
    );
  }

  @BeforeEach
  void setup() {
    pr = new Pr144BinTreePreorderTr();
  }

  @ParameterizedTest
  @MethodSource("provideData")
  void testAll(TreeNode root, List<Integer> inOrderValues) {
    assertEquals(inOrderValues, pr.preorderTraversal(root));
  }
